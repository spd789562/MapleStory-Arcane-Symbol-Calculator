...
const _symbolsAtom = atomWithStorage<Record<SymbolRegionType, SymbolState>>(
  legacyStorageKey,
  {
...
export const symbolAtomMap = {
  [ArcaneSymbolType.VanishingJourney]: createSymbolStateAtoms(
    ArcaneSymbolType.VanishingJourney,
  ),
  [ArcaneSymbolType.ChuChu]: createSymbolStateAtoms(ArcaneSymbolType.ChuChu),
  [ArcaneSymbolType.Lachelein]: createSymbolStateAtoms(
    ArcaneSymbolType.Lachelein,
  ),
  ...
  [GrandisSymbolType.Cernium]: createSymbolStateAtoms(
    GrandisSymbolType.Cernium,
  ),
  [GrandisSymbolType.HotelArcs]: createSymbolStateAtoms(
    GrandisSymbolType.HotelArcs,
  ),
  [GrandisSymbolType.Odium]: createSymbolStateAtoms(GrandisSymbolType.Odium),
  [GrandisSymbolType.ShangriLa]: createSymbolStateAtoms(
    GrandisSymbolType.ShangriLa,
  ),
  [GrandisSymbolType.Arteria]: createSymbolStateAtoms(
    GrandisSymbolType.Arteria,
  ),
  [GrandisSymbolType.Carcion]: createSymbolStateAtoms(
    GrandisSymbolType.Carcion,
  ),
  [GrandisSymbolType.Tallahart]: createSymbolStateAtoms(
    GrandisSymbolType.Tallahart,
  ),
};
